...
public class EditPanel extends LoadingSimplePanel {
	...
	public EditPanel(MainServiceAsync main, Button main2, TextItem nameOfCompany, TextItem login, 
			TextItem PhonetextBox, TextItem Skypetextbox, TextItem Emailtextbox, TextItem nameOfReliable, TextItem phoneOfReliable) {
		isReady = true;
		mainService = main;
		...
		this.Skypetextbox = Skypetextbox;
