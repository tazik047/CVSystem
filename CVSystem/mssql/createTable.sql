...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Favorites_Students]') AND parent_object_id = OBJECT_ID(N'[dbo].[Favorites]'))
ALTER TABLE [dbo].[Favorites] DROP CONSTRAINT [FK_Favorites_Students]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Favorites_Companies]') AND parent_object_id = OBJECT_ID(N'[dbo].[Favorites]'))
ALTER TABLE [dbo].[Favorites] DROP CONSTRAINT [FK_Favorites_Companies]
GO
...
GO
/****** Object:  Table [dbo].[ProgramLanguages]    Script Date: 21.04.2015 0:27:44 ******/
...
GO
/****** Object:  Table [dbo].[Pass]    Script Date: 21.04.2015 0:27:44 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Pass]') AND type in (N'U'))
DROP TABLE [dbo].[Pass]
GO
/****** Object:  Table [dbo].[LanguagesCVs]    Script Date: 21.04.2015 0:27:44 ******/
...
USE [CVSystem]
GO
/****** Object:  Table [dbo].[Companies]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  Table [dbo].[CVs]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Educations]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Faculties]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Favorites]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Groups]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Languages]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[LanguagesCVs]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Pass]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[ProgramLanguages]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[ProgramLanguagesCVs]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Purposes]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Roles]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Sertificats]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Students]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Users]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[WorkExps]    Script Date: 21.04.2015 0:27:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Favorites_Companies]') AND parent_object_id = OBJECT_ID(N'[dbo].[Favorites]'))
ALTER TABLE [dbo].[Favorites]  WITH CHECK ADD  CONSTRAINT [FK_Favorites_Companies] FOREIGN KEY([CompaniesId])
REFERENCES [dbo].[Companies] ([CompaniesId])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Favorites_Companies]') AND parent_object_id = OBJECT_ID(N'[dbo].[Favorites]'))
ALTER TABLE [dbo].[Favorites] CHECK CONSTRAINT [FK_Favorites_Companies]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Favorites_Students]') AND parent_object_id = OBJECT_ID(N'[dbo].[Favorites]'))
ALTER TABLE [dbo].[Favorites]  WITH CHECK ADD  CONSTRAINT [FK_Favorites_Students] FOREIGN KEY([StudentsId])
REFERENCES [dbo].[Students] ([StudentsId])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Favorites_Students]') AND parent_object_id = OBJECT_ID(N'[dbo].[Favorites]'))
ALTER TABLE [dbo].[Favorites] CHECK CONSTRAINT [FK_Favorites_Students]
GO
