...
GO
ALTER DATABASE [CVSystem] SET  DISABLE_BROKER 
GO
...
ALTER TABLE [dbo].[Groups]  WITH CHECK ADD  CONSTRAINT [FK_Groups_Faculties] FOREIGN KEY([FacutiesId])
